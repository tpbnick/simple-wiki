...
>
  <div class="px-2 py-1 text-xs font-medium text-base-content/50 bg-base-200 border-b border-base-300">
    Markdown
  </div>
  <textarea
    bind:this={textarea}
    ...
    ondrop={(e) => { e.preventDefault(); dragOver = false; onFileDrop(e.dataTransfer?.files ?? null) }}
  ></textarea>
</div>
