...
<div class="mb-4 flex justify-end">
  <a
    href="/wiki/new/edit?ns=template"
      ...
      {#each templates as tmpl}
        <tr class="hover:bg-base-200/30 transition-colors group">
          ...
          <td class="px-3 py-3 text-base-content/50 text-xs">
            <time
              datetime={toDatetimeAttr(tmpl.updated_at)}
              title={formatDateTime(tmpl.updated_at)}
            >
