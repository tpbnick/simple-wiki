...
const existingPages = $derived(new Set(Array.isArray(existingPageSlugs) ? existingPageSlugs : []))
...
const lineage = $derived(lineagePersonId ? getPaternalLineage(lineagePersonId, data) : null)
